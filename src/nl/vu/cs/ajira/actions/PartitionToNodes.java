...
public class PartitionToNodes extends Action {
	...
	/**
	 * The <code>BA_SORTING_FIELDS</code> parameter is of type
	 * <code>byte[]</code>, is not required, and is only significant when the
	 ...
	 * the byte array contains <code>{2, 0}</code>, the sorting will use field 2
	 * and field 0, in that order. When not specified, all fields are used, in
	 * ascending order.
	 */
	public static final int BA_SORTING_FIELDS = 4;
	...
	private static class ParametersProcessor extends ActionConf.Configurator {
		...
		public void setupAction(InputQuery query, Object[] params,
			...
			params[BA_SORTING_FIELDS] = convertToBytes(params[BA_SORTING_FIELDS]);
	...
	public void registerActionParameters(ActionConf conf) {
		...
		conf.registerParameter(BA_SORTING_FIELDS, "IA_SORTING_FIELDS", null,
				false);
	...
	public void startProcess(ActionContext context) throws Exception {
		...
		sortingFields = getParamByteArray(BA_SORTING_FIELDS);
