...
public class DefaultFileReader implements FileReader {
	...
	public void init(File file) throws IOException {
		...
		if (file.getName().endsWith(".gz") || file.getParent().endsWith(".gz")) {
	...
	/**
	 * Tries to read one line from the input file, and returns whether it can be
	 * obtained by {@link #getTuple(Tuple)}.
	 *
	 * @throws IOException
	 *             in case of trouble.
	 * @return <code>true</code> if it was possible to read a line,
